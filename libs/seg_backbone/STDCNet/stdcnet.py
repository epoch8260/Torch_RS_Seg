...
def stdcnet14446():
    ...
    ckpt = torch.load(r'E:\Building Extraction\big_models\libs\seg_backbone\STDCNet\STDCNet1446_76_47.pth', map_location='cpu')
...
def stdcnet813():
    ...
    ckpt = torch.load(r'E:\Building Extraction\big_models\libs\seg_backbone\STDCNet\STDCNet813M_73.91.pth', map_location='cpu')
    state_dict = ckpt["state_dict"]
    self_state_dict = model.state_dict()
    for k, v in state_dict.items():
        self_state_dict.update({k: v})
...
if __name__ == "__main__":
    ...
    # print(y.size())
    # ckpt = torch.load(r'E:\Building Extraction\big_models\libs\seg_backbone\STDCNet\STDCNet1446_76_47.pth', map_location='cpu')
    # model.load_state_dict( ckpt["state_dict"], strict=False)  # or train from scratch
