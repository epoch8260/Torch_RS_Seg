...
def get_model(pretrained=True):
    model = DualResNet(block=BasicBlock, layers=[2, 2, 2, 2], planes=32, last_planes=1024)
    if pretrained:
        checkpoint = torch.load(r'E:\Building Extraction\big_models\libs\seg_backbone\DDRNet\DDRNet23s_imagenet.pth', map_location='cpu')
